...
},{"./lib/axios":"../../../node_modules/axios/lib/axios.js"}],"products.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              window.location.href = "".concat(window.location.origin, "/dashboard/products/all");
            }
...
exports.deleteOrder = exports.updateOrder = void 0;
...
var updateOrder = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(form) {
    var delivery, payment, data, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            delivery = form.delStatus.selectedOptions[0].value === "delivered" ? true : false;
            payment = form.payStatus.selectedOptions[0].value === "paid" ? true : false;
            data = {
              paid: payment,
              delivered: delivery
            };
          ...
          case 6:
            ...
            if (res.data.status === "success") {
              window.location.href = "".concat(window.location.origin, "/dashboard/orders/all");
            }
...
},{"axios":"../../../node_modules/axios/index.js","regenerator-runtime":"../../../node_modules/regenerator-runtime/runtime.js"}],"admin.js":[function(require,module,exports) {
"use strict";
...
function _handleProductForms() {
  _handleProductForms = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee(e) {
...
function handleProductDelete(_x2) {
  return _handleProductDelete.apply(this, arguments);
}

function _handleProductDelete() {
  _handleProductDelete = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee2(e) {
...
function handleLoginForm(_x5) {
  return _handleLoginForm.apply(this, arguments);
}

function _handleLoginForm() {
  _handleLoginForm = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee5(e) {
